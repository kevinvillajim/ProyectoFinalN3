    ...
    <div id="total-container" class="w-screen h-screen">
        <div id="left-menu" class="bg-[#343b40] w-[100%] h-[100%]">
            ...
            <div class="p-[1rem]">
                ...
                <h2 class="text-[#fff]">
                    <?php $estudiante = $_SESSION["user"]["nombre"];
                    echo "$estudiante"; ?>
                </h2>
            </div>
            <hr />
            <div class="p-[1rem] space-y-[1rem]">
                ...
                <a href="/clases/alumno">
                    <h3 class="text-[#fff] flex cursor-pointermy-[1rem]">
                        <span class="material-symbols-outlined mr-[1rem]">
                                ...
                                foreach ($data['calificaciones'] as $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="h-[3rem] bg-[#f2f2f2] flex items-center">
                                            <?php
                                            if ($item['msg_count']) {
                                                echo "<div class='flex direction-row items-center' id='msg'><span class='material-symbols-outlined cursor-pointer text-[black]'>sms</span><div class='bg-[red] p-[0.15rem] rounded-full text-[10px] text-[#fff] mb-[1.3rem] cursor-pointer'>{$item['msg_count']}</div></div>";
                                            } else {
